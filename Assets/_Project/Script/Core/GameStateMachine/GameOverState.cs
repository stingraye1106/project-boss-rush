...
namespace NF.Main.Core.GameStateMachine
{
    public class GameOverState : GameBaseState
    {
        ...
        public GameOverState(GameManager gameManager, GameState gameState, PlayerInputReader inputReader, PlayerCharacter player, EnemyCharacter enemy) : base(gameManager, gameState)
        {
